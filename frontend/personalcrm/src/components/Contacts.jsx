...
function Contacts() {
  ...
  useEffect(() => {
    ...
    animations.add("(max-width: 600px)", () => {
      ScrollTrigger.getAll().forEach((st) => st.kill()); // Remove all ScrollTrigger instances
      gsap.killTweensOf(cardsRef.current); // Kill all tweens of the card elements
    });

    return () => {
      animations.revert(); // Clean up
    };
  }, [contacts]);
  ...
  //       scrollTriggerTl.to(
  //         "#first",
  //         { x: 325, opacity: 1, ease: "power1.in", duration: 1 },
  //         "anim"
  //       );
  //       scrollTriggerTl.to(
  //         "#second",
  //         { x: -300, opacity: 1, delay: 0.4, duration: 1, ease: "power1.in" },
  //         "anim"
  //       );
  //       scrollTriggerTl.to(
  //         "#third",
  //         { opacity: 1, delay: 0.7, x: 200, ease: "power1.in", duration: 1 },
  //         "anim"
  //       );
  //       }});
  ...
  //       scrollTriggerTl.to(
  //         "#first",
  //         { x: 150, opacity: 1, ease: "power1.in", duration: 1 },
  //         "anim"
  //       );
  //       scrollTriggerTl.to(
  //         "#second",
  //         { x: -150, opacity: 1, delay: 0.4, duration: 1, ease: "power1.in" },
  //         "anim"
  //       );
  //       scrollTriggerTl.to(
  //         "#third",
  //         { opacity: 1, delay: 0.7, x: 100, ease: "power1.in", duration: 1 },
  //         "anim"
  //       );
  //     }
  //   });
  ...
  //     toggleActions: "play reverse play reverse",
  //     onEnter: () =>
  //       gsap.to(".main", { backgroundColor: "gray", color: "black" }),
  //     onLeaveBack: () =>
